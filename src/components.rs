    ...
    cx.render(rsx! {
        div {
            ...
            input {
                ...
                oninput: move |ev|{
                    let temp_val = ev.data.value.parse::<f64>().unwrap() / 20.0;
                    value.set(temp_val);
                    on_event.call(temp_val);
                }
            }
        ...
        div{
            ...
            div{
                ...
                Toggleable{
                    name: "Scale AR",
                    title: "Scale AR: Scales the AR of the map with the rate.",
                    toggled: settings.read().scale_ar,
                    on_event: move |ev: bool| settings.write().scale_ar = !ev
                }
                Toggleable{
                    name: "Override audio",
                ...
                Toggleable{
                    name: "Scale OD",
                    title: "Scale OD: Scales the OD of the map with the rate.",
                    toggled: settings.read().scale_od,
                    on_event: move |ev: bool| settings.write().scale_od = !ev
                }
            }
        }
    })
    ...
    cx.render(rsx!{
        ...
        div {
            ...
            div{
                ...
                button {
                        class: "settings-button",
                        title: "Recalculate space: Calculates the amount of space used by the .osu and audio files generated by ruso",
                        onclick: move |_| {
                ...
                button {
                    class: "settings-button",
                    title: "Clean maps: This will remove all files that ruso has generated, including audio files generated by ruso.",
                    onclick: move |_| {
    ...
    cx.render(rsx!{
        ...
        div{
            ...
            RateSlider {
                ...
                on_event: move |ev| {
                    map.write().rate = ev;
                    if settings.read().scale_ar{
                        map.write().scale_ar();
                    }
                    if settings.read().scale_od{
                        map.write().scale_od();
                    }
                },
                // rate: map.read().rate
